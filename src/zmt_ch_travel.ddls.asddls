...
define root view entity ZMT_CH_TRAVEL as select from /dmo/travel_m
--Composition child for travel viz booking
composition[0..*] of ZMT_CH_BOOKING as _Booking
composition[0..*] of zmt_CH_m_attach as _Attachments
   ...
   $projection.OverallStatus = _OverallStatus.OverallStatus
{
   ...
   { entity: {
               name: 'ZMT_CH_AGENCY_ES5',/*'/DMO/I_Agency',*/
               element: 'Agency_Id'
       } }
   ]
