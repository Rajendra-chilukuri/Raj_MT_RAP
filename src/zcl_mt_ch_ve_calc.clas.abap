CLASS zcl_mt_ch_ve_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_mt_ch_ve_calc IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
  check not it_original_data is initial.
   data: lt_calc_data type standard table of zmt_ch_travel_processor with DEFAULT KEY,
