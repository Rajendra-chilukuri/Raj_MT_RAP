CLASS lsc_zmt_ch_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zmt_ch_travel IMPLEMENTATION.
    ...
    IF update-travel IS NOT INITIAL.
      ...
      LOOP AT update-travel ASSIGNING FIELD-SYMBOL(<travel_log_update>).
        ...
        IF <travel_log_update>-%control-CustomerId = if_abap_behv=>mk-on.
          ...
          <travel_log_db>-changed_field_name = 'mouritech_Rajen_customer'.
        ...
        IF <travel_log_update>-%control-AgencyId = if_abap_behv=>mk-on.
          <travel_log_db>-change_id = cl_system_uuid=>create_uuid_x16_static( ).
          <travel_log_db>-changed_field_name = 'mouritech_Rajen_agency'.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS earlynumbering_create FOR NUMBERING
      IMPORTING entities FOR CREATE Travel.
    TYPES: t_entity_create TYPE TABLE FOR CREATE zmt_ch_travel,
           t_entity_update TYPE TABLE FOR UPDATE zmt_ch_travel,
           t_entity_rep    TYPE TABLE FOR REPORTED zmt_ch_travel,
           t_entity_err    TYPE TABLE FOR FAILED zmt_ch_travel.

    METHODS precheck_Rajendra_reuse
      IMPORTING
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF zmt_ch_travel IN LOCAL MODE
        ENTITY travel
    ...
    LOOP AT lt_travel INTO DATA(ls_travel).
      ...
      IF ( ls_travel-OverallStatus = 'X' ).
        ...
        AUTHORITY-CHECK OBJECT 'ZMTCH_MGR'
        ID 'ACTVT' FIELD '03'.
        IF sy-subrc = 0.
          lv_auth = abap_true.
        ENDIF.
  ...
  METHOD earlynumbering_create.
    DATA: entity        TYPE STRUCTURE FOR CREATE zmt_CH_travel,
...
*        CATCH cx_number_ranges.
  ...
  METHOD copyTravel.
    DATA: travels       TYPE TABLE FOR CREATE zmt_ch_travel\\Travel,
          bookings_cba  TYPE TABLE FOR CREATE zmt_ch_travel\\Travel\_Booking,
          booksuppl_cba TYPE TABLE FOR CREATE zmt_ch_travel\\Booking\_BookingSupplement.
    ...
    MODIFY ENTITIES OF zmt_ch_travel IN LOCAL MODE
        ENTITY travel
...
*                     ) TO reported-travel.
  ...
  METHOD precheck_Rajendra_reuse.
