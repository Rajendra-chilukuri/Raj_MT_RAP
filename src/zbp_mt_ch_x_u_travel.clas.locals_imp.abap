CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES: tt_travel_failed   TYPE TABLE FOR FAILED Zmt_ch_X_U_TRAVEL,
           tt_travel_reported TYPE TABLE FOR REPORTED Zmt_ch_X_U_TRAVEL.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<travel_Create>).
      ...
      travel_in-travel_id       = <travel_create>-TravelId.
...
CLASS lsc_ZMT_CH_X_U_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZMT_CH_X_U_TRAVEL IMPLEMENTATION.
