...
define view entity ZMT_CH_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZMT_CH_BOOKING as _Booking on
  $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId

association[1..1] to ZMT_CH_TRAVEL as _Travel on
