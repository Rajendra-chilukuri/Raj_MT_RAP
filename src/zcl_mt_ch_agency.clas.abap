CLASS zcl_mt_ch_agency DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_mt_ch_agency IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    DATA:
      lt_business_data TYPE TABLE OF zmt_ch_agencies=>tys_z_travel_agency_es_5_type,
