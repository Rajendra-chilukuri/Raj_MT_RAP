...
define view entity ZMT_CH_BOOKING as select from /dmo/booking_m
composition[0..*] of ZMT_CH_BOOKSUPPL as _BookingSupplement
association to parent ZMT_CH_TRAVEL as _Travel on
